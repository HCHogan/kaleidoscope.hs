module KaleidoscopeHs.Parser.Combinator () where

import Control.Applicative (liftA2, liftA3)
import Control.Monad.Combinators.Expr
import Data.Either
import KaleidoscopeHs.Ast
import KaleidoscopeHs.Scanner.Combinator
...
formalsP = parens $ formalP `sepBy` comma
 where
  formalP = liftA2 Bind typeP identifier
